...
python LICID.py 64 11 1 no_fix 1 GUROBI
python LICID.py 128 5 1 no_fix 1 CPLEX
'''
...
def PrintOuter(FixList,BanList):
    opOuter = open("Outer" +"_LICID_" + str(LICID) + "_" + str(ROUND) +".lp",'w+')
...
def PrintInner(FixList, SolveList):
    opInner = open("Inner" +"_LICID_" + str(LICID) + "_" + str(ROUND)+".lp","w+")
...
bl = []
FixList = []
filename = "Result" +"_LICID_" + str(LICID) + "_" + str(ROUND) + ".txt"
...
while (count<=int(sys.argv[5])):
    ...
    if(GUROBI_EXISTS == True):
        o = read("Outer" +"_LICID_" + str(LICID) + "_" + str(ROUND) +".lp")
        o.optimize()
        obj = o.getObjective()
    ##########################CPLEX####################################
    if(CPLEX_EXISTS == True):
        mr = ModelReader()
        o = mr.read("Outer" +"_LICID_" + str(LICID) + "_" + str(ROUND) +".lp")
    ...
    if o_obj < (min_sbox + 64) :
        ...
        ###########################GUROBI#################################
        if(GUROBI_EXISTS == True):
            i = read("Inner" +"_LICID_" + str(LICID) + "_" + str(ROUND) +".lp")
            i.optimize()
            i_obj = i.getObjective().getValue()
        ###################CPLEX#############################
        if(CPLEX_EXISTS == True):
            i = mr.read("Inner" +"_LICID_" + str(LICID) + "_" + str(ROUND) +".lp")
